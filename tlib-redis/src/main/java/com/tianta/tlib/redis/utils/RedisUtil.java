package com.tianta.tlib.redis.utils;

import com.tianta.tlib.redis.RedisExceptionUtil;
...
public class RedisUtil {
    ...
    public void set(String key, Object value) {
        RedisExceptionUtil.checkKeyException(key);
        RedisExceptionUtil.checkObjectIsNull(value);
    ...
    public void set(String key, Object value, long time, TimeUnit unit) {
        ...
        if (time > 0) {
            RedisExceptionUtil.checkObjectIsNull(value, "时间单元不能为空");
    ...
    public void hset(String key, String item, Object value) {
        RedisExceptionUtil.checkKeyException(key);
        RedisExceptionUtil.checkObjectIsNull(item, key + ":->hash-key不能为空");
        RedisExceptionUtil.checkObjectIsNull(value);
    ...
    public long sSet(String key, Object... values) {
        RedisExceptionUtil.checkKeyException(key);
        RedisExceptionUtil.checkObjectIsNull(values);
